...
import bg.softuni.pathfinder.service.impl.CommentServiceIml;
...
public class CommentController {
    ...
    private final CommentServiceIml commentService;

    public CommentController(CommentServiceIml commentService) {
