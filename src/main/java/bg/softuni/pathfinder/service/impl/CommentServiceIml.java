...
public class CommentServiceIml implements CommentService {
    ...
    public CommentServiceIml(CommentRepository commentRepository, RouteRepository routeRepository, UserRepository userRepository, LoggedUser loggedUser, ModelMapper mapper) {
    ...
    public void create(CreateCommentBindingModel createCommentBindingModel) {
        ...
        if (optionalUser.isEmpty()) {
            throw new UserNotFoundException("User with username: " + loggedUser.getUsername() + " not found");
        }
